// ==============================================================
// ThreeD Garden Page (main landing page for ThreeD Soccer + Character Demo)
...
// const SoccerPage: TNextPageWithProps = (): React.ReactNode => {
const SoccerPage: TNextPageWithProps = (pages: any): React.ReactNode => {
// const SoccerPage: TNextPageWithProps = async () => {
// const SoccerPage: TNextPageWithProps = async ({ children }: React.PropsWithChildren): Promise<React.ReactNode> => {
  // **
